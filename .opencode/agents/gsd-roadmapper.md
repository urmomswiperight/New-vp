...
Reference full template: `D:/New-vp-main/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/New-vp-main/.opencode/get-shit-done/templates/state.md`.
