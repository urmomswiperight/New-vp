...
Before sketching anything, explore the design intent through conversation. Ask one question at a time using question, with a paragraph of context and reasoning for each.
