...
```
Task(
  prompt="Read D:/New-vp-main/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/New-vp-main/.opencode/get-shit-done/templates/SECURITY.md`
