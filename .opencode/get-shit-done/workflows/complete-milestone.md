...
```bash
node "D:/New-vp-main/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `D:/New-vp-main/.opencode/get-shit-done/templates/retrospective.md`.
