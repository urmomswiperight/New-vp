...
<reference>
@D:/New-vp-main/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/New-vp-main/.claude/get-shit-done/references/user-profiling.md` to load:
