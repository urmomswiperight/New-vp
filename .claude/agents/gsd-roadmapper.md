...
Reference full template: `D:/New-vp-main/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/New-vp-main/.claude/get-shit-done/templates/state.md`.
