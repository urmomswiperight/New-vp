...
```
Task(
  prompt="Read D:/New-vp-main/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/New-vp-main/.claude/get-shit-done/templates/VALIDATION.md`
