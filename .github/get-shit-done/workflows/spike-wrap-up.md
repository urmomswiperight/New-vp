...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.github/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.github/skills/` with SKILL.md, references/, sources/
