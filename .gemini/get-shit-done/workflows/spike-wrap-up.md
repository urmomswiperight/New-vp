...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.gemini/skills/spike-findings-[project]/`
...
3. Check if `./.gemini/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.gemini/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.gemini/skills/spike-findings-[project]/`
...
**Feature areas:** {list}
**Skill:** `./.gemini/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.gemini/skills/` with SKILL.md, references/, sources/
