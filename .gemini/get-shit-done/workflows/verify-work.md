...
<template>
@D:/New-vp-main/.gemini/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/New-vp-main/.gemini/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/New-vp-main/.gemini/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/New-vp-main/.gemini/get-shit-done/workflows/diagnose-issues.md
