...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.gemini/skills/sketch-findings-[project]/`
...
3. Check if `./.gemini/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.gemini/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.gemini/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.gemini/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.gemini/skills/` with SKILL.md, references/, sources/
