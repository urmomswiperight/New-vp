...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.trae/skills/sketch-findings-[project]/`
...
3. Check if `./.trae/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.trae/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.trae/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.trae/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.trae/skills/` with SKILL.md, references/, sources/
