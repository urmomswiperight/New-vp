...
```
Task(
  prompt="Read D:/New-vp-main/.trae/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/New-vp-main/.trae/get-shit-done/templates/SECURITY.md`
