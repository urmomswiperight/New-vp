...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.trae/skills/spike-findings-[project]/`
...
3. Check if `./.trae/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.trae/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.trae/skills/spike-findings-[project]/`
...
## Update Project .trae/rules/

Add an auto-load routing line to the project's .trae/rules/ (create the file if it doesn't exist):
...
**Feature areas:** {list}
**Skill:** `./.trae/skills/spike-findings-[project]/`
**Summary:** `.planning/spikes/WRAP-UP-SUMMARY.md`
**.trae/rules/:** routing line added
...
- [ ] Spike-findings skill exists at `./.trae/skills/` with SKILL.md, references/, sources/
...
- [ ] Project .trae/rules/ has auto-load routing line
