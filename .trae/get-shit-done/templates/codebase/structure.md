...
**commands/gsd/**
- Purpose: Slash command definitions for Trae
...
- `.trae/rules/` - Instructions for Trae when working in this repo
...
- Usage: Reference from command with `@D:/New-vp-main/.trae/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/New-vp-main/.trae/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/New-vp-main/.trae/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
