...
<required_reading>
@D:/New-vp-main/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/New-vp-main/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/New-vp-main
                  → checks D:/New-vp-main/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/New-vp-main/get-shit-done
                  → writes to D:/New-vp-main/get-shit-done/hooks/
...
@D:/New-vp-main/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/New-vp-main/get-shit-done/references/common-bug-patterns.md
