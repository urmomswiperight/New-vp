...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.cline/skills/spike-findings-[project]/`
...
3. Check if `./.cline/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.cline/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.cline/skills/spike-findings-[project]/`
...
## Update Project .clinerules

Add an auto-load routing line to the project's .clinerules (create the file if it doesn't exist):
...
**Feature areas:** {list}
**Skill:** `./.cline/skills/spike-findings-[project]/`
**Summary:** `.planning/spikes/WRAP-UP-SUMMARY.md`
**.clinerules:** routing line added
...
- [ ] Spike-findings skill exists at `./.cline/skills/` with SKILL.md, references/, sources/
...
- [ ] Project .clinerules has auto-load routing line
