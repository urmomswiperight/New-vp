...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.cline/skills/sketch-findings-[project]/`
...
3. Check if `./.cline/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.cline/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.cline/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.cline/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.cline/skills/` with SKILL.md, references/, sources/
