...
```bash
INIT=$(node "D:/New-vp-main/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/New-vp-main/get-shit-done/templates/spec.md.
