...
Key references:
- @D:/New-vp-main/get-shit-done/references/ui-brand.md (display patterns)
- @D:/New-vp-main/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/New-vp-main/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/New-vp-main/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/New-vp-main/get-shit-done/USER-PROFILE.md" "D:/New-vp-main/USER-PROFILE.backup.md"
```
...
Your recent Cline sessions, looking for patterns in these
...
✓ Stores profile at D:/New-vp-main/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/New-vp-main/get-shit-done/references/user-profiling.md`
...
Reference: @D:/New-vp-main/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/New-vp-main/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - ".clinerules profile section" -- "Add profile to this project's .clinerules"
  - "Global .clinerules" -- "Add profile to D:/New-vp-main/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/New-vp-main/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/New-vp-main/commands/gsd/dev-preferences.md"

**For .clinerules profile section (if selected):**

```bash
gsd-sdk query generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Added profile section to .clinerules"

**For Global .clinerules (if selected):**

```bash
gsd-sdk query generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to D:/New-vp-main/.clinerules"
...
```bash
BACKUP_PATH="D:/New-vp-main/USER-PROFILE.backup.md"
```
...
Your profile:    D:/New-vp-main/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/New-vp-main/commands/gsd/dev-preferences.md
  ✓ .clinerules section       .clinerules
  ✓ Global .clinerules        D:/New-vp-main/.clinerules
```
