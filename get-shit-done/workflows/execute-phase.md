...
- **Cline:** Uses `Task(subagent_type="gsd-executor", ...)` — blocks until complete, returns result
...
@D:/New-vp-main/get-shit-done/references/context-budget.md
@D:/New-vp-main/get-shit-done/references/gates.md
</required_reading>

<available_agent_types>
These are the valid GSD subagent types registered in .cline/agents/ (or equivalent for your runtime).
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @D:/New-vp-main/get-shit-done/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @D:/New-vp-main/get-shit-done/references/planner-antipatterns.md
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `D:/New-vp-main/get-shit-done/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Task(
     ...
     prompt="
       ...
       <execution_context>
       @D:/New-vp-main/get-shit-done/workflows/execute-plan.md
       @D:/New-vp-main/get-shit-done/templates/summary.md
       @D:/New-vp-main/get-shit-done/references/checkpoints.md
       @D:/New-vp-main/get-shit-done/references/tdd.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@D:/New-vp-main/get-shit-done/references/executor-examples.md'}
       </execution_context>
       ...
       ` : ''}
       - .clinerules (Project instructions, if exists — follow project-specific guidelines and coding conventions)
       - .cline/skills/ or .agents/skills/ (Project skills, if either exists — list skills, read SKILL.md for each, follow relevant rules during implementation)
       </files_to_read>

       ${AGENT_SKILLS}

       <mcp_tools>
       If .clinerules or project instructions reference MCP tools (e.g. jCodeMunch, context7,
...
4. **Wait for all agents in wave to complete.**
   ...
   **This fallback applies automatically to all runtimes.** Cline's Task() normally
...
Read and follow `D:/New-vp-main/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
