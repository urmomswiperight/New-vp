...
**commands/gsd/**
- Purpose: Slash command definitions for Cline
...
- `.clinerules` - Instructions for Cline when working in this repo
...
- Usage: Reference from command with `@D:/New-vp-main/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/New-vp-main/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/New-vp-main/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
