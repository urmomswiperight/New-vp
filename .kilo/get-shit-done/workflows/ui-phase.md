...
```markdown
Read D:/New-vp-main/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/New-vp-main/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/New-vp-main/.kilo/agents/gsd-ui-checker.md for instructions.
