...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.kilo/skills/spike-findings-[project]/`
...
3. Check if `./.kilo/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.kilo/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.kilo/skills/spike-findings-[project]/`
...
**Feature areas:** {list}
**Skill:** `./.kilo/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.kilo/skills/` with SKILL.md, references/, sources/
