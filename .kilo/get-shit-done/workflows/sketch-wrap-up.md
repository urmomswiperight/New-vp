...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.kilo/skills/sketch-findings-[project]/`
...
3. Check if `./.kilo/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.kilo/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.kilo/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.kilo/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.kilo/skills/` with SKILL.md, references/, sources/
