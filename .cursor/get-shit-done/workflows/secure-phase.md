...
```
Task(
  prompt="Read D:/New-vp-main/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/New-vp-main/.cursor/get-shit-done/templates/SECURITY.md`
