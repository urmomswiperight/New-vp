...
<required_reading>
@D:/New-vp-main/.cursor/get-shit-done/references/ai-frameworks.md
@D:/New-vp-main/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/New-vp-main/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/New-vp-main/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/New-vp-main/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/New-vp-main/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/New-vp-main/.cursor/agents/gsd-eval-planner.md for instructions.
