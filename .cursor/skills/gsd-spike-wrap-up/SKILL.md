...
project history. Output skill goes to `./.cursor/skills/spike-findings-[project]/` (project-local).
</objective>

<execution_context>
@D:/New-vp-main/.cursor/get-shit-done/workflows/spike-wrap-up.md
...
<process>
Execute the spike-wrap-up workflow from @D:/New-vp-main/.cursor/get-shit-done/workflows/spike-wrap-up.md end-to-end.
Preserve all curation gates (per-spike review, grouping approval, .cursor/rules/ routing line).
</process>
