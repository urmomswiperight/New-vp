...
<execution_context>
@D:/New-vp-main/.cursor/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/New-vp-main/.cursor/get-shit-done/workflows/session-report.md end-to-end.
</process>
