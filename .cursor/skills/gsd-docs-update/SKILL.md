...
<execution_context>
@D:/New-vp-main/.cursor/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/New-vp-main/.cursor/get-shit-done/workflows/docs-update.md end-to-end.
