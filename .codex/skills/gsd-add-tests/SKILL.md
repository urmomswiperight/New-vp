...
<execution_context>
@D:/New-vp-main/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @D:/New-vp-main/.codex/get-shit-done/workflows/add-tests.md end-to-end.
