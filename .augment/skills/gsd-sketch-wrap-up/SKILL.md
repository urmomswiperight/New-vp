...
project history. Output skill goes to `./.augment/skills/sketch-findings-[project]/` (project-local).
</objective>

<execution_context>
@D:/New-vp-main/.augment/get-shit-done/workflows/sketch-wrap-up.md
...
<process>
Execute the sketch-wrap-up workflow from @D:/New-vp-main/.augment/get-shit-done/workflows/sketch-wrap-up.md end-to-end.
Preserve all curation gates (per-sketch review, grouping approval, .augment/rules/ routing line).
</process>
