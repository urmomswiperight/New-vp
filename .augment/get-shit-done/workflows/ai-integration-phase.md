...
```markdown
Read D:/New-vp-main/.augment/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/New-vp-main/.augment/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/New-vp-main/.augment/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/New-vp-main/.augment/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/New-vp-main/.augment/agents/gsd-eval-planner.md for instructions.
