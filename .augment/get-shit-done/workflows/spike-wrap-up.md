...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.augment/skills/spike-findings-[project]/`
...
3. Check if `./.augment/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.augment/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.augment/skills/spike-findings-[project]/`
...
**Feature areas:** {list}
**Skill:** `./.augment/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.augment/skills/` with SKILL.md, references/, sources/
