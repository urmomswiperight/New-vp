...
- Generates `./.augment/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.augment/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `D:/New-vp-main/.augment/notes/` globally)
