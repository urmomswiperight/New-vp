...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.augment/skills/sketch-findings-[project]/`
...
3. Check if `./.augment/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.augment/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.augment/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.augment/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.augment/skills/` with SKILL.md, references/, sources/
