...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE=".windsurf/rules"; fi
```
...
SPIKE_SKILL=$(ls ./.windsurf/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.windsurf/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1)
...
Use template: D:/New-vp-main/.windsurf/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: D:/New-vp-main/.windsurf/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: D:/New-vp-main/.windsurf/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: D:/New-vp-main/.windsurf/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: D:/New-vp-main/.windsurf/get-shit-done/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `.windsurf/rules` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, .windsurf/rules otherwise)
