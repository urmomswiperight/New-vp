...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.windsurf/skills/sketch-findings-[project]/`
...
3. Check if `./.windsurf/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.windsurf/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.windsurf/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.windsurf/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.windsurf/skills/` with SKILL.md, references/, sources/
