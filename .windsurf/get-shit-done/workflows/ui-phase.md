...
```markdown
Read D:/New-vp-main/.windsurf/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/New-vp-main/.windsurf/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/New-vp-main/.windsurf/agents/gsd-ui-checker.md for instructions.
