...
```
Task(
  prompt="Read D:/New-vp-main/.windsurf/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/New-vp-main/.windsurf/get-shit-done/templates/VALIDATION.md`
