...
**GSD** (Get Shit Done) creates hierarchical project plans optimized for solo agentic development with Windsurf.
...
- Generates `./.windsurf/skills/spike-findings-[project]/` with references and sources
- Writes summary to `.planning/spikes/WRAP-UP-SUMMARY.md`
- Adds auto-load routing line to project .windsurf/rules
...
- Generates `./.windsurf/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `D:/New-vp-main/.windsurf/notes/` globally)
