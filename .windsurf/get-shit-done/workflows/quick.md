...
- .windsurf/rules (if exists — project-specific guidelines)
...
- .windsurf/rules (if exists — follow project-specific guidelines)
...
- .planning/STATE.md (Project state)
- .windsurf/rules (Project instructions, if exists)
