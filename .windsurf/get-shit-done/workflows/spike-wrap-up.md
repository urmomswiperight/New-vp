...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.windsurf/skills/spike-findings-[project]/`
...
3. Check if `./.windsurf/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.windsurf/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.windsurf/skills/spike-findings-[project]/`
...
## Update Project .windsurf/rules

Add an auto-load routing line to the project's .windsurf/rules (create the file if it doesn't exist):
...
**Feature areas:** {list}
**Skill:** `./.windsurf/skills/spike-findings-[project]/`
**Summary:** `.planning/spikes/WRAP-UP-SUMMARY.md`
**.windsurf/rules:** routing line added
...
- [ ] Spike-findings skill exists at `./.windsurf/skills/` with SKILL.md, references/, sources/
...
- [ ] Project .windsurf/rules has auto-load routing line
