...
**commands/gsd/**
- Purpose: Slash command definitions for Windsurf
...
- `.windsurf/rules` - Instructions for Windsurf when working in this repo
...
- Usage: Reference from command with `@D:/New-vp-main/.windsurf/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/New-vp-main/.windsurf/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/New-vp-main/.windsurf/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
