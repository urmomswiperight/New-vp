...
<execution_context>
@D:/New-vp-main/.windsurf/get-shit-done/workflows/settings.md
</execution_context>

<process>
**Follow the settings workflow** from `@D:/New-vp-main/.windsurf/get-shit-done/workflows/settings.md`.
