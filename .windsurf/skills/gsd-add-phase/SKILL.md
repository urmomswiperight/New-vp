...
<execution_context>
@D:/New-vp-main/.windsurf/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@D:/New-vp-main/.windsurf/get-shit-done/workflows/add-phase.md`.
