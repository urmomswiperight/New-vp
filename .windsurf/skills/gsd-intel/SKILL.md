...
## A. Skill Invocation
- This skill is invoked when the user mentions `gsd-intel` or describes a task matching this skill.
...
Project root: ${CWD}
Prefer: gsd-sdk query <subcommand> (installed gsd-sdk on PATH). Legacy: node D:/New-vp-main/.windsurf/get-shit-done/bin/gsd-tools.cjs
