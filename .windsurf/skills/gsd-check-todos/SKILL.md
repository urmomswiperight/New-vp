...
<execution_context>
@D:/New-vp-main/.windsurf/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@D:/New-vp-main/.windsurf/get-shit-done/workflows/check-todos.md`.
