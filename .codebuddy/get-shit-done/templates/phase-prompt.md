...
<!-- For checkpoint task examples and patterns, see @D:/New-vp-main/.codebuddy/get-shit-done/references/checkpoints.md -->
...
See `D:/New-vp-main/.codebuddy/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/New-vp-main/.codebuddy/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/New-vp-main/.codebuddy/get-shit-done/workflows/verify-phase.md` for verification logic.
