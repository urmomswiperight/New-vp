...
Key references:
- @D:/New-vp-main/.codebuddy/get-shit-done/references/ui-brand.md (display patterns)
- @D:/New-vp-main/.codebuddy/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/New-vp-main/.codebuddy/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/New-vp-main/.codebuddy/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/New-vp-main/.codebuddy/get-shit-done/USER-PROFILE.md" "D:/New-vp-main/.codebuddy/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/New-vp-main/.codebuddy/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/New-vp-main/.codebuddy/get-shit-done/references/user-profiling.md`
...
Reference: @D:/New-vp-main/.codebuddy/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/New-vp-main/.codebuddy/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/New-vp-main/.codebuddy/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/New-vp-main/.codebuddy/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/New-vp-main/.codebuddy/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/New-vp-main/.codebuddy/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/New-vp-main/.codebuddy/USER-PROFILE.backup.md"
```
...
Your profile:    D:/New-vp-main/.codebuddy/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/New-vp-main/.codebuddy/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/New-vp-main/.codebuddy/CLAUDE.md
```
