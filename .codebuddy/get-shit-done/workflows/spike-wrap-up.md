...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.codebuddy/skills/spike-findings-[project]/`
...
3. Check if `./.codebuddy/skills/spike-findings-*/SKILL.md` exists for this project
...
2. The skill will be created at `./.codebuddy/skills/spike-findings-[project-dir-name]/`
...
**Feature areas:** [list]
**Skill output:** `./.codebuddy/skills/spike-findings-[project]/`
...
**Feature areas:** {list}
**Skill:** `./.codebuddy/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.codebuddy/skills/` with SKILL.md, references/, sources/
