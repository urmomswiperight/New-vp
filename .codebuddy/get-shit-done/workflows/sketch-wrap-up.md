...
UI implementation. Reads from `.planning/sketches/`, writes skill to `./.codebuddy/skills/sketch-findings-[project]/`
...
3. Check if `./.codebuddy/skills/sketch-findings-*/SKILL.md` exists for this project
...
Derive from the project directory name: `./.codebuddy/skills/sketch-findings-[project-dir-name]/`
...
**Design areas:** [list]
**Skill output:** `./.codebuddy/skills/sketch-findings-[project]/`
...
**Design areas:** {list}
**Skill:** `./.codebuddy/skills/sketch-findings-[project]/`
...
- [ ] Sketch-findings skill exists at `./.codebuddy/skills/` with SKILL.md, references/, sources/
