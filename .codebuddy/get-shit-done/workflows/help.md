...
- Generates `./.codebuddy/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.codebuddy/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `D:/New-vp-main/.codebuddy/notes/` globally)
