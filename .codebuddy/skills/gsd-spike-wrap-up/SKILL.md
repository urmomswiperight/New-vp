...
project history. Output skill goes to `./.codebuddy/skills/spike-findings-[project]/` (project-local).
</objective>

<execution_context>
@D:/New-vp-main/.codebuddy/get-shit-done/workflows/spike-wrap-up.md
...
<process>
Execute the spike-wrap-up workflow from @D:/New-vp-main/.codebuddy/get-shit-done/workflows/spike-wrap-up.md end-to-end.
Preserve all curation gates (per-spike review, grouping approval, CODEBUDDY.md routing line).
</process>
