...
<execution_context>
@D:/New-vp-main/.qwen/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Context files (QWEN.md, REVIEW.md, phase state) are resolved inside the workflow via `gsd-sdk query init.phase-op` and delegated to agent via config blocks.
</context>

<process>
This command is a thin dispatch layer. It parses arguments and delegates to the workflow.

Execute the code-review-fix workflow from @D:/New-vp-main/.qwen/get-shit-done/workflows/code-review-fix.md end-to-end.
