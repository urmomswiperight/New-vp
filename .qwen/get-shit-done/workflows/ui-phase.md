...
```markdown
Read D:/New-vp-main/.qwen/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/New-vp-main/.qwen/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/New-vp-main/.qwen/agents/gsd-ui-checker.md for instructions.
